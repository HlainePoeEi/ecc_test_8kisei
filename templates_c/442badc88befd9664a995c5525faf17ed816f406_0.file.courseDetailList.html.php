<?php
/* Smarty version 3.1.29, created on 2022-10-13 11:48:06
  from "/var/www/html/eccadmin_dev/templates/courseDetailList.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_63477c6689d714_92794843',
  'file_dependency' => 
  array (
    '442badc88befd9664a995c5525faf17ed816f406' => 
    array (
      0 => '/var/www/html/eccadmin_dev/templates/courseDetailList.html',
      1 => 1547458228,
      2 => 'file',
    ),
  ),
...
function content_63477c6689d714_92794843 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
CourseDetailList/Search" method="post">
...
?>
						...
						<tr>
							<td>コース詳細名</td>
							<td class="input">
								<input class="text" type="text" name="course_detail_name" id="course_detail_name" value="<?php echo $_smarty_tpl->tpl_vars['form']->value->course_detail_name;?>
...
<br />
										<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result']->value->course_detail_romaji, ENT_QUOTES, 'UTF-8', true);?>
</td>
 ...
 ~ <?php echo $_smarty_tpl->tpl_vars['result']->value->end_period;?>
									...
									<td class="td_img">
										<input type="button" class="btn_qa_assign" title="割当" name="assign" onclick="assign_question('<?php echo $_smarty_tpl->tpl_vars['result']->value->course_detail_no;?>
','<?php echo @constant('HOME_DIR');?>
QuestionAssignmentList/index')">
									</td>
									<td class="td_img">
										<input type="button" class="btn_edit" title="編集" name="edit" onclick="edit_trans('<?php echo $_smarty_tpl->tpl_vars['result']->value->course_detail_no;?>
','<?php echo @constant('HOME_DIR');?>
CourseDetailRegist/index')">
									</td>
									<td class="td_img">
										<input type="button" class="btn_delete" title="削除" name="delete" onclick="del_trans('<?php echo $_smarty_tpl->tpl_vars['result']->value->course_detail_no;?>
','<?php echo @constant('HOME_DIR');?>
CourseDetailList/delete')">
									</td>
								</tr>
								<?php
