<?php
/* Smarty version 3.1.29, created on 2022-04-15 19:01:07
  from "/var/www/html/eccadmin_dev/templates/courseDetailRegist.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_62594263833235_33243493',
  'file_dependency' => 
  array (
    '5c3187a34b424b53e00a41250a631fdea5bf5d0f' => 
    array (
      0 => '/var/www/html/eccadmin_dev/templates/courseDetailRegist.html',
      1 => 1622772472,
      2 => 'file',
    ),
  ),
...
function content_62594263833235_33243493 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
	<head>
...
image/calendar.svg",
				...
				$(".btn_insert").on('click', function() {
					...
					var course_detail_romaji = document.getElementById('course_detail_romaji').value;
					...
					if ( course_detail_name == "" ){
						...
						$(".error_msg").html("コース詳細名を入力してください。");
						return false;
					}

					// コース詳細名の文字数チェック
					if ( course_detail_name.length > 64 ){
						$('#err_dis').show();
						$(".error_section").slideToggle('slow');
						$(".error_msg").html("コース詳細名は64字で入力してください。");
						return false;
					}

					// 読みの必須チェック
					if ( course_detail_romaji == "" ){
						$('#err_dis').show();
						$(".error_section").slideToggle('slow');
						$(".error_msg").html("コース詳細名（英語）字を入力してください。");
						return false;
					}

					// 読みの文字数チェック
					if ( course_detail_romaji.length > 64 ){
						$('#err_dis').show();
						$(".error_section").slideToggle('slow');
						$(".error_msg").html("コース詳細名（英語）は64字で入力してください。");
						return false;
					}
...
CourseDetailRegist/save" method="post">
			<input type="hidden" id="back_flg" name="back_flg" value="false" />
			<input type="hidden" id="course_detail_no" value="<?php echo $_smarty_tpl->tpl_vars['form']->value->course_detail_no;?>
" name="course_detail_no"/>
...
"/>
			<input type="hidden" id="search_course_detail_name" name="search_course_detail_name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['search_course_detail_name']->value, ENT_QUOTES, 'UTF-8', true);?>
"/>
...
image/close_icon.png" style="width:15px;float:right" class="close_icon">
				...
				<section class="content">
					<p>><span class="title">コース /コース詳細登録</span></p>
...
CourseDetailList/search')"></p>
				<table class="lessonRegist">
					<tr>
						<td style="width:240px;">
							<label class="lbl_name" >コース詳細名<span class="required">※</span></label>
						</td>
						<td>
							<input id="course_detail_name" name="course_detail_name" type="text" class="text_box" maxlength="64" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value->course_detail_name, ENT_QUOTES, 'UTF-8', true);?>
" >
						</td>
					</tr>
					<tr>
						<td>
							<label class="lbl_name">コース詳細名（英語）<span class="required">※</span></label>
						</td>
						<td>
							<input id="course_detail_romaji" name="course_detail_romaji" type="text" class="text_box" maxlength="64" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value->course_detail_romaji, ENT_QUOTES, 'UTF-8', true);?>
">
						</td>
					</tr>
					<tr>
...
>
			...
			function doBack(action) {
				...
				$("#search_course_detail_name").val(document.getElementById('search_course_detail_name').value);
