<?php
/* Smarty version 3.1.29, created on 2022-10-13 11:45:09
  from "/var/www/html/eccadmin_dev/templates/testInfoRegist.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_63477bb5e931b5_98111153',
  'file_dependency' => 
  array (
    'e31e0deb14e8b6d64cc05220c1c6e937de1b8c96' => 
    array (
      0 => '/var/www/html/eccadmin_dev/templates/testInfoRegist.html',
      1 => 1659952657,
      2 => 'file',
    ),
  ),
...
function content_63477bb5e931b5_98111153 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
TestInfoRegist/save" method="post">
...
">
							...
							<tr>
								...
								<td width="80%"><input type="text" class="text"
...
" maxlength="64" size="30"></td>
							...
							<tr style="border: 1px solid #dddddd;">
								...
								<td><textarea name="long_description" id="long_description"
...
" maxlength="5" oninput="javascript: if (this.value.length > this.maxLength) this.value = Math.abs(this.value.slice(0, this.maxLength)); else this.value = Math.abs(this.value);">
								</td>
							</tr>
							<tr>
								<td>結果表示</td>
								<td><?php if ($_smarty_tpl->tpl_vars['form']->value->show_flg != 1) {?> <input type="radio"
							...
							<tr>
								...
								<td><?php if ($_smarty_tpl->tpl_vars['form']->value->status != 1) {?> <input type="radio"
							...
							<tr>
								...
								<td><?php if (($_smarty_tpl->tpl_vars['date_flg']->value == 1)) {?> <input type="text"
...
" maxlength="10"
							...
							<tr>
								...
								<td><input type="text" id="end_period" name="end_period"
...
" maxlength="10"
							...
							<tr>
								<td>備考</td>
								<td><input type="text" class="text" id="remarks"
