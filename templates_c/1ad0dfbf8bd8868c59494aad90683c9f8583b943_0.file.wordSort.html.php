<?php
/* Smarty version 3.1.29, created on 2022-07-13 13:19:55
  from "/var/www/html/eccadmin_dev/templates/wordSort.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_62ce47ebd72e46_85799848',
  'file_dependency' => 
  array (
    '1ad0dfbf8bd8868c59494aad90683c9f8583b943' => 
    array (
      0 => '/var/www/html/eccadmin_dev/templates/wordSort.html',
      1 => 1640334843,
      2 => 'file',
    ),
  ),
...
function content_62ce47ebd72e46_85799848 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="<?php echo @constant('HOME_DIR');?>
js/wordSort.js"><?php echo '</script'; ?>
>
...
css/default.css" rel="stylesheet">
    <link href="<?php echo @constant('HOME_DIR');?>
css/wordSort.css"	rel="stylesheet">
	</head>
<body class="pushmenu-push">
	<form id="main_form" action="<?php echo @constant('HOME_DIR');?>
WordSort/save" method="post">
...
" />
						...
						<input type="hidden" name="wordbook_id" id="wordbook_id" value="<?php echo $_smarty_tpl->tpl_vars['form']->value->wordbook_id;?>
" />
...
"/>
						<table class="testAss_tbl">
							<tr>
								...
								<td class="td_input"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</td>
							</tr>
						</table>
						<br>
						<table id="testAss_lowertbl1" class="myTable join_header_border_quiz">
								<thead>
								 ...
								 <?php if (count($_smarty_tpl->tpl_vars['wordList']->value) == 1) {?>
								 <tbody>
									<?php
$_from = $_smarty_tpl->tpl_vars['wordList']->value;
...
?>
									<tr style="width:100%;">
										<td style="width:150px;"><?php echo $_smarty_tpl->tpl_vars['result']->value->disp_no;?>
</td>
										<td style="width:300px;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result']->value->word, ENT_QUOTES, 'UTF-8', true);?>
</td>
										<td style="width:700px;"><?php echo $_smarty_tpl->tpl_vars['result']->value->translation;?>
</td>
...
image/down.svg"  style="width: 25px;height:25px;"/></button>
										...
										<td><?php echo $_smarty_tpl->tpl_vars['result']->value->word_id;?>
</td>
									</tr>
									<?php
...
image/down.svg"  style="width: 25px;height:25px;"/></button>
									...
									<?php } elseif ($_smarty_tpl->tpl_vars['key']->value == count($_smarty_tpl->tpl_vars['wordList']->value)-1) {?>
										<tr style="width:100%;">
										<td style="width:150px;"><?php echo $_smarty_tpl->tpl_vars['result']->value->disp_no;?>
</td>
										<td style="width:300px;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['result']->value->word, ENT_QUOTES, 'UTF-8', true);?>
...
?>
			...
			<table class="btn_div">
				<tr>
					...
					onclick="javascript:cancel('<?php echo $_smarty_tpl->tpl_vars['form']->value->wordbook_id;?>
