<?php
/* Smarty version 3.1.29, created on 2022-11-22 08:43:08
  from "C:\xampp\htdocs\ecc_test\templates\leftMenu.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_637c7d8c5b91a7_32991523',
  'file_dependency' => 
  array (
...
function content_637c7d8c5b91a7_32991523 ($_smarty_tpl) {
?>
	...
	<div style="overflow: auto;" id="div_menu">
		<ul>
			<li class="drawer-dropdown" id="menu_li_wordMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					...
					<span class="wordMenuIcon"></span><label class="menu-label">Origin</label>
		...
		<ul>
			<li class="drawer-dropdown" id="menu_li_wordMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="wordMenu">
					<span class="wordMenuIcon1"></span><label class="menu-label">YNS</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="YNSWordRegist">単語登録</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="YNSWordList">単語一覧</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_orgMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="orgMenu">
					<span class="orgMenuIcon"></span><label class="menu-label">組織</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="OrganizationList">組織一覧</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="OrganizationRegist/index">組織登録</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_swApp">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="swAppMenu">
					<span class="courseMenuIcon"></span><label class="menu-label">SW 申込</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="CourseContractList">コース契約一覧</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_swStatus">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="swStatusMenu">
					<span class="courseMenuIcon"></span><label class="menu-label">SW 状況</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="CourseContractConfirmList">コース契約確認</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="CourseStatusList">コース受講状況一覧</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_swref">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="swRefMenu">
					<span class="courseMenuIcon"></span><label class="menu-label">SW 参照</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="SWPracticeReferenceList">SW
							Practice 参照</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_testMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="testMenu">
				...
				<ul class="drawer-dropdown-menu" style="display:none;">
					...
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="TestRegist">テスト登録</a></li>
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="QuizList">クイズ一覧</a></li>
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="QuizRegist">クイズ登録</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_testInfoMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="testInfoMenu">
				...
				<ul class="drawer-dropdown-menu" style="display:none;">
					...
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="TestInfoRegist">試験登録</a></li>
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="QuizInfoList">クイズ一覧</a></li>
					<li class="admintype5"><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="QuizInfoRegist">クイズ登録</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_teacher">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="teacherMenu">
		...
		<ul>
			<li class="drawer-dropdown" id="menu_li_reportMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="reportMenu">
				...
				<ul class="drawer-dropdown-menu" style="display:none;">
					...
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ReportRegist">レポート登録</a>
					</li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_atReportMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="atReportMenu">
					<span class="reportMenuIcon"></span><label class="menu-label">Online Practice</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="AtReportList">Online
							Practice List</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="AtReportRegist">Online
							Practice Regist</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_excel_extract">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="excelExtractMenu">
					<span class="courseMenuIcon"></span><label class="menu-label">データ抽出</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="SubjectAreaSubjectDataExport">教科：科目</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ManagerDataExport">担当者</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="LessonDataExport">レッスン</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="GroupDataExport">グループ</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="StudentDataExport">受講者</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ManagerSubjectLessonDataExport">担当者：教科：レッスン</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="GroupStudentDataExport">グループ：受講者</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="LessonGroupStudentDataExport">レッスン：グループ：受講者</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_excel">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="excelMenu">
					<span class="courseMenuIcon"></span><label class="menu-label">データ登録</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelSubjectAreaList">教科登録</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ExcelSubjectList">科目登録</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelLessonManagerList">担当者登録</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ExcelLessonList">レッスン登録</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ExcelGroupList">グループ登録</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="ExcelStudentList">受講者登録</a>
					</li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelLessonGroupList">レッスン：グループ登録</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelGroupStudentList">グループ：受講者登録</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelStudentNoChangeList">受講者番号更新</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelContractList">契約情報登録</a></li>
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="ExcelContract2SkillList">2技能契約受講者登録</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_noticeMenu">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="noticeMenu">
					<span class="noticeMenuIcon"></span><label class="menu-label">お知らせ</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);"
							id="SystemNoticeRegist">お知らせ設定</a></li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_setting">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="settingMenu">
				...
				<ul class="drawer-dropdown-menu" style="display:none;">
					...
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="CourseDetailList">コース詳細</a>
					</li>
		...
		<ul>
			<li class="drawer-dropdown" id="menu_li_pswChange">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" data-toggle="dropdown"
					role="button" aria-expanded="false" id="pswChangeMenu">
					<span class="settingMenuIcon"></span><label class="menu-label">パスワード変更</label>
					<span class="drawer-caret"></span>
				</a>
				<ul class="drawer-dropdown-menu" style="display:none;">
					<li><a class="drawer-dropdown-menu-item" href="javascript:void(0);" id="PasswordChange">パスワード変更</a>
					</li>
				</ul>
			</li>
		</ul>
		<ul>
			<li class="drawer-dropdown" id="menu_li_logout">
				<a class="drawer-menu-item" data-target="#" href="javascript:void(0);" id="logout"
					onclick="doLogout();">
