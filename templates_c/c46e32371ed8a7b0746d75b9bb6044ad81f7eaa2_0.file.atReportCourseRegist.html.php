<?php
/* Smarty version 3.1.29, created on 2022-08-29 17:03:54
  from "/var/www/html/eccadmin_dev/templates/atReportCourseRegist.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_630c72ea2b7893_35529935',
  'file_dependency' => 
  array (
    'c46e32371ed8a7b0746d75b9bb6044ad81f7eaa2' => 
    array (
      0 => '/var/www/html/eccadmin_dev/templates/atReportCourseRegist.html',
      1 => 1648094043,
      2 => 'file',
    ),
  ),
...
function content_630c72ea2b7893_35529935 ($_smarty_tpl) {
...
<html>
<head>
<title>Online Practice コース設定</title>
...
AtReportCourseRegist/Search" method="post">
...
"
							...
							<tr>
								...
								<td class="input"><input class="text" type="text"
									...
									value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form']->value->course_name, ENT_QUOTES, 'UTF-8', true);?>
						...
						<table id="test_assign_tbl_cb" class="tbl_search" style="border-collapse: collapse; font-size: 1.0em;width:100%" style="display:none;">
							<thead>
								<tr>
									...
									<th style="width:300px;!important">コース</th>
									<th width="100px">コースID</th>
									<th width="100px">Offer番号</th>
...
?>
									<?php if ($_smarty_tpl->tpl_vars['result']->value->checked == "1") {?>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "selected", 0);?>
									<?php }?>
								<tr id="course_id_<?php echo $_smarty_tpl->tpl_vars['result']->value->offer_no;?>
...
">
									...
									<td style="width:300px;!important"><?php echo smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['result']->value->course_name, ENT_QUOTES, 'UTF-8', true),40,'...');?>
</td>
									<td width="100px"><?php echo $_smarty_tpl->tpl_vars['result']->value->course_id;?>
</td>
									<td width="100px"><?php echo $_smarty_tpl->tpl_vars['result']->value->offer_no;?>
</td>
...
>
			...
			function reporttestsave(org_no,report_no,action) {
				...
				var array = [];
				var course_id = document.querySelectorAll('input[type=checkbox]:checked')

				for (var i = 0; i < course_id.length; i++) {
				
					array.push(course_id[i].value);
			...
			$(function(){
				...
				$('#test_assign_tbl_cb tbody tr').each(function() {
					...
					course_id = course_id.split("quiz_no_")[1];
	
					entryList = $("#entryList").val();
					entryList = entryList.split(",");
	
					var flag = $.inArray( course_id, entryList);
			...
			$('#test_assign_tbl_cb tbody tr').on('click', function(){
				...
				var course_id = $(this).attr('id');
				course_id = course_id.split("course_id_")[1];
				...
				if(selected_class.length > 1){
					...
					var temp = $.inArray( course_id, quiz_list );
					if(temp != -1){
						test_selected_list = test_selected_list.replace(course_id+",", "");
					}
